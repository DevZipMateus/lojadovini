      ...
      <section id="destaques" className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <h3 className="text-xl font-bold text-primary mb-2">Atendemos Belo Horizonte e região</h3>
              <p className="text-gray-600">Entrega rápida e segura em toda a região</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
